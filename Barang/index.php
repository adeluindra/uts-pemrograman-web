...
<body class="bg-gradient-to-r from-teal-500 to-blue-600 p-6">
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        <h1 class="text-4xl font-bold mb-6 text-blue-900">Barang</h1>
        <p class="text-gray-800 mb-4 text-lg">List Semua Data Barang</p>
            ...
            <table class="min-w-full bg-white border border-gray-300 shadow-sm rounded-lg">
                <thead class="bg-teal-100 text-gray-700">
                    <tr>
                        ...
                        <th class="py-4 px-6 text-left text-sm font-medium">Kode Barang</th>
                        <th class="py-4 px-6 text-left text-sm font-medium">Nama Barang</th>
                        <th class="py-4 px-6 text-left text-sm font-medium">Kategori</th>
                        <th class="py-4 px-6 text-left text-sm font-medium">Harga</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-teal-50 hover:bg-teal-200 transition-all duration-300">
                        ...
                        <td class="py-4 px-6 border-b text-sm"><?php echo $row['kodebrg']; ?></td>
                        <td class="py-4 px-6 border-b text-sm"><?php echo $row['namabrg']; ?></td>
                        <td class="py-4 px-6 border-b text-sm"><?php echo $row['kategori']; ?></td>
                        <td class="py-4 px-6 border-b text-sm"><?php echo $row['harga']; ?></td>
